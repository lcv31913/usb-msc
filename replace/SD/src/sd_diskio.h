...
bool sd_read_raw(uint8_t pdrv, uint8_t* buffer, uint32_t sector, uint32_t number);
bool sd_write_raw(uint8_t pdrv, uint8_t* buffer, uint32_t sector, uint32_t number);
#endif /* _SD_DISKIO_H_ */
